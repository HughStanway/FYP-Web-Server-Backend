...
class JavaParser(Parser):
    ...
    def compilationUnit(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                while (
                    (((_la - 1)) & ~0x3F) == 0
                    and ((1 << (_la - 1)) & -1125457390829311) != 0
                ) or (
                    (((_la - 65)) & ~0x3F) == 0
    ...
    def genericInterfaceMethodDeclaration(self):
        ...
        try:
            ...
            while (
                (((_la - 1)) & ~0x3F) == 0
                and ((1 << (_la - 1)) & -1125470410110975) != 0
            ) or (
                (((_la - 65)) & ~0x3F) == 0
                and ((1 << (_la - 65)) & -8935141660703064063) != 0
            ):
                self.state = 601
                self.interfaceMethodModifier()
                self.state = 606
        ...
        try:
            ...
            if la_ == 1:
                ...
                if (
                    (
                        (((_la - 3)) & ~0x3F) == 0
                        and ((1 << (_la - 3)) & 9223090579141953573) != 0
                    )
                    or _la == 123
                    or _la == 128
                ):
                ...
                if (
                    (
                        (((_la - 3)) & ~0x3F) == 0
                        and ((1 << (_la - 3)) & 9223090579141986341) != 0
                    )
                    or _la == 123
                    or _la == 128
                ):
    ...
    class AnnotationContext(ParserRuleContext):
        ...
        def altAnnotationQualifiedName(self):
            return self.getTypedRuleContext(
                JavaParser.AltAnnotationQualifiedNameContext, 0
            )
        ...
        try:
            ...
            if la_ == 1:
                ...
                if (
                    (
                        (((_la - 18)) & ~0x3F) == 0
                        and ((1 << (_la - 18)) & 281466386776065) != 0
                    )
                    or _la == 123
                    or _la == 128
                ):
